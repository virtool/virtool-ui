...
describe("<UploadTime />", () => {
    it("displays remaining time and speed correctly for less than 12 hours", () => {
        renderWithProviders(<UploadTime remaining={3600} uploadSpeed={5000000} />); // 1 hour, 5 MB/s
    ...
    it('displays "0 seconds remaining" when no time is left', () => {
        renderWithProviders(<UploadTime remaining={0} uploadSpeed={1000000} />); // 0 seconds, 1 MB/s
    ...
    it("displays remaining time and speed correctly for more than 12 hours", () => {
        renderWithProviders(<UploadTime remaining={65000} uploadSpeed={1000000} />); // 12.5 hours, 1 MB/s
