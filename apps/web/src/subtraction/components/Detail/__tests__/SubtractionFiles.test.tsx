...
import SubtractionFiles, {
	type SubtractionFilesProps,
...
describe("<SubtractionFiles />", () => {
	...
	beforeEach(() => {
		props = {
			files: [
				{
					download_url: "/api/subtractions/xl8faqqz/uploads/subtraction.fa.gz",
					id: 1,
					name: "foo",
					size: 36461731,
				...
				{
					download_url: "/api/subtractions/k66fpdyy/uploads/subtraction.3.bt2",
					id: 2,
					name: "bar",
					size: 3257,
