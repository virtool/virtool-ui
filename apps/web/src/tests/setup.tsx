...
beforeEach(() => {
	...
	for (const fn of [
		...
		sampleServerFnMocks.findSamples,
		sampleServerFnMocks.getSample,
	...
	for (const fn of [
		...
		sampleServerFnMocks.createSample,
		sampleServerFnMocks.updateSample,
		sampleServerFnMocks.deleteSample,
		sampleServerFnMocks.updateSampleRights,
