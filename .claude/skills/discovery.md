...
Use a general-purpose sub-agent to fetch the Linear project. Include the
following instructions in the prompt:

> You research Linear projects for the Virtool team.
>
...
> - Return the full project description, goals, and all issues with their
>   descriptions.
> - Include the project identifier, title, status, lead, and priority.
...
These are the technical domains the project touches. For example, "real-time
sync", "canvas rendering", "file parsing".
...
2. **External prior art**: Research how performance-focused companies solved
   similar problems. Focus on companies known for near-native performance and
   UX: Linear, Figma, Canva, Discord, Notion, and similar. Look for
   engineering blog posts, tech talks, and documented architectural decisions.
...
Create a Linear project document called "Discovery" using the save_document
...
#### External Prior Art
- {Company}: {how they solved it, with focus on performance decisions}
