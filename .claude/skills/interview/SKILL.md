...
Include the following instructions in the prompt:
...
> - Fetch the project and find the document called "Discovery".
> - Return the full content of the Discovery document.
> - Also return the current project description.
...
- Group related decisions when it makes sense: "Since you chose X for
  rendering, that narrows the library options to A or B."
